...
<body class="w-full min-h-screen flex justify-center items-center bg-cover bg-center bg-fixed z-10 bg-[url('../../img/pixels14.jpg')]">
    <div class="flex flex-col max-w-[90%] w-[40em] bg-gray-300 p-8 rounded shadow-xl gap-6">
        ...
        <form method="POST" action="" class="flex flex-col w-full justify-center items-center gap-6">
            ...
            <select name="id_proyecto" required class="p-2 border rounded-xl w-full">
            ...
            <select name="usuario_asignado" required class="p-2 border rounded-xl w-full">
            ...
            <input type="date" name="fecha_vencimiento" required class="p-2 border rounded-xl w-full" />
