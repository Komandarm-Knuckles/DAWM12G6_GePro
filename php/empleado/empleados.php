  ...
  <body class="w-full min-h-screen flex flex-col justify-center items-center bg-cover bg-center bg-fixed z-10 bg-[url('../../img/pixels14.jpg')]">
      ...
      <div class="flex flex-col p-10 bg-gray-300 bg-opacity-90 gap-10 rounded-xl w-full max-w-[90%]">
          ...
          <h3 class="font-bold text-orange-500 text-3xl text-center underline">Información de Reuniones</h3>
          ...
          <h3 class="font-bold text-orange-500 text-3xl text-center underline">Información de Tareas</h3>
          ...
          <form action="../../php/logout.php" method="POST" class="flex items-center justify-center">
              <button type="submit" class="p-2 bg-orange-400 rounded-xl shadow-lg cursor-pointer p-3 text-white hover:bg-orange-800">Cerrar Sesión</button>
          </form>
